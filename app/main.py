...
REDIS_FAILURES = Counter('redis_failures_total', 'Total number of Redis failures', registry=REGISTRY)
REDIS_LATENCY = Gauge('redis_latency_seconds', 'Redis operation latency in seconds', registry=REGISTRY)
STRIPE_FAILURES = Counter('stripe_failures_total', 'Total number of Stripe failures', registry=REGISTRY)
STRIPE_LATENCY = Gauge('stripe_latency_seconds', 'Stripe operation latency in seconds', registry=REGISTRY)
